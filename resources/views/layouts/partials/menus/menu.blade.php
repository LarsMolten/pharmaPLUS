 ...
 <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
     <div class="main-menu-content">
         <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
             ...
             <li class=" nav-item active"><a href="{{ route('dashboard.index') }}" ><i class="la la-shopping-cart"></i><span
                         class="menu-title" data-i18n="dashboard">Dashboard</span></a>
             </li>

             <li class=" nav-item"><a href="#" ><i class="la la-shopping-cart"></i><span
                         class="menu-title" data-i18n="vente">Ventes</span></a>
             </li>
             ...
             <li class=" nav-item"><a href="#" ><i class="la la-user"></i><span
