<div class="heading-elements mt-0">
            <div class="modal fade" id="AjoutArticleModal" style="z-index: 99999999" tabindex="-1" role="dialog"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="designation" required name="designation"
                                                        class="form-control input-sm" placeholder="Désignation">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="selectpicker  form-control btn-sm" name="unite"
                                                        required id="unite" data-live-search='true' data-size='5'
                                                        title='Unité'>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control input-sm" name="presentation" required
                                                        type="text" placeholder="Presentation" id="presentation">
                                                </div>
                                            </div>
