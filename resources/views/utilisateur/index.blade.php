...
@section('app-content')
    ...
    <section class="page-wrapper" data-page="utilisateur">
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body" id="card_liste_utilisateur">
                            <center>
                                <h6 class="text-center" style="font-size: 14px; margin-bottom: -25px;">Liste Utilisateurs
                                </h6>
                            </center>

                            <table id="card_utilisateur"
